...
housing_percent = int(housing/budget*100)
utilities_percent = int(utilities/budget*100)
groceries_percent = int(groceries/budget*100)
transportation_percent = int(transportation/budget*100)
health_care_percent = int(health_care/budget*100)
personal_care_percent = int(personal_care/budget*100)
clothing_percent = int(clothing/budget*100)
debt_percent = int(debt/budget*100)
...
print(f"You use roughly {budget_utilitization}% of your total budget!")